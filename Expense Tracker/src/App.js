...
import { collection, addDoc, updateDoc, deleteDoc, doc } from "firebase/firestore"; // Include doc in the import statement
...
function App() {
  ...
  const updateExpense = async (expense) => {
    ...
    // Update expense in Firestore using updateDoc
